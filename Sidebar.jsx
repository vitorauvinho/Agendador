...
const NAV_ANALISTA = [
  { path: '/minha-trilha',    icon: '🗓️', label: 'Minha trilha' },
  { path: '/estudar',         icon: '📖', label: 'Estudar' },
  { path: '/minha-gamificacao', icon: '⭐', label: 'Minha gamificação' },
]
...
export default function Sidebar({ activeTeam, onTeamChange, pendingCount = 0 }) {
  ...
  return (
    <aside style={{
      ...
      padding: '18px 0', height: '100vh', overflow: 'hidden',
    }}>
      {/* Logo */}
      ...
      <div style={{ padding: '0 8px', marginBottom: 6 }}>
        <div style={{ fontSize: 8, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.1em', padding: '0 8px', marginBottom: 4 }}>
          Enablement
        </div>
          ...
          return (
            <div key={item.path}
              ...
              style={{
                ...
                fontSize: 12, color: isActive ? 'var(--auvo)' : 'var(--muted2)',
      ...
      <div style={{ marginTop: 'auto', padding: '12px 8px 0', borderTop: '1px solid var(--border)' }}>
        <div style={{ fontSize: 8, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 6 }}>
          Time ativo
        </div>
        {[
          ...
          <button key={t.key}
            ...
            style={{
              ...
              border: `1px solid ${activeTeam === t.key ? 'var(--auvo-border)' : 'var(--border)'}`,
              background: activeTeam === t.key ? 'var(--auvo-dim)' : 'transparent',
              color: activeTeam === t.key ? 'var(--auvo)' : 'var(--muted2)',
